...
public class Lotak_Bank implements RBI_Bank_Interface {

    private double balance;
    private String password;
    private String account_number;
    private double rate_of_intrest = 7.6;
    private int minimum_balance = 500;

    public Lotak_Bank(String account_number, String password, double balance){
